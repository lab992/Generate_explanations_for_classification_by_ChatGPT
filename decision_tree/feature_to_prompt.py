...
def gen_context():
    ...
    #                      )
    class_description2 = ("if 'acceleration__number_crossing_m__m_1' is high then class: 2 \n" 
                          "if 'acceleration__number_crossing_m__m_1' is low and 'acceleration__agg_linear_trend__attr_'intercept'__chunk_len_5__f_agg_'min'' is high and 'acceleration__range_count__max_1000000000000.0__min_0' is high then class: 3\n"
                          "if 'acceleration__number_crossing_m__m_1' is low and 'acceleration__agg_linear_trend__attr_'intercept'__chunk_len_5__f_agg_'min'' is low and 'acceleration__approximate_entropy__m_2__r_0.7' is high then class: 2\n"
                          "if 'acceleration__number_crossing_m__m_1' is low and 'acceleration__agg_linear_trend__attr_'intercept'__chunk_len_5__f_agg_'min'' is low and 'acceleration__approximate_entropy__m_2__r_0.7' is low then class: 3\n"
                          "if 'acceleration__number_crossing_m__m_1' is low and 'acceleration__agg_linear_trend__attr_'intercept'__chunk_len_5__f_agg_'min'' is high and 'acceleration__range_count__max_1000000000000.0__min_0' is low then class: 4\n"
                          )
    ...
    return mission + class_description2 + rules
